...
const LoginPage = () => {
  ...
  return (
    <div className="bg-[url(./src/assets/bgImage.png)] bg-contain min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl">
      {/* Left */}
